...
class BaseTileLayer {
  constructor(parent) {
    ...
    (0, _defineProperty2.default)(this, "tilePickService", void 0);
    ...
    (0, _defineProperty2.default)(this, "mapchange", () => {
      ...
      yield Promise.all(tiles.map( /*#__PURE__*/function () {
        var _ref = (0, _asyncToGenerator2.default)(function* (tile) {
          ...
          if (!_this.tileLayerService.hasTile(tile.key)) {
            const tileInstance = (0, _tile.getTileFactory)(_this.parent);
   ...
   */
  proxy(parent) {
    _constants.ProxyFuncs.forEach(func => {
      // @ts-ignore
