import type { IGlobalConfigService, IMapConfig, IMapService, IMapWrapper, L7Container } from '@antv/l7-core';
export default class BaseMapWrapper<RawMap> implements IMapWrapper {
    ...
    setContainer(sceneContainer: L7Container, id: string | HTMLDivElement, canvas?: HTMLCanvasElement): void;
