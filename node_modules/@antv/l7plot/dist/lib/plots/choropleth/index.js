...
var Choropleth = /** @class */ (function (_super) {
     ...
     * 初始化图例事件
     */
    Choropleth.prototype.initLegendEvent = function () {
        var _this = this;
        var legend = this.options.legend;
        if (!legend)
            return;
        var onUpdateLegendData = function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        geoData = (_b = this.options.source) === null || _b === void 0 ? void 0 : _b.joinBy.geoData;
                        _c.label = 1;
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, Promise.all([fetchChinaBoundaryData, this.getDistrictData(geoData)])];
                    case 2:
                        _a = tslib_1.__read.apply(void 0, [_c.sent(), 1]), this.chinaBoundaryData = _a[0];
                        return [3 /*break*/, 4];
                    case 3:
                        err_1 = _c.sent();
     ...
     * 更新显示区域
     */
    Choropleth.prototype.changeView = function (view_1) {
