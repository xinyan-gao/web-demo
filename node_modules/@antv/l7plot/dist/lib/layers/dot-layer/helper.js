...
var getColorLegendItems = function (legendItems) {
    ...
    // TODO: scale nice
    var items = legendItems.map(function (item) { return (tslib_1.__assign(tslib_1.__assign({}, item), { value: [(0, lodash_es_1.round)(item.value[0], 4), (0, lodash_es_1.round)(item.value[1], 4)] })); });
    return items;
};
