...
export declare const lodashUtil: {
    ...
    throttle: <T extends (...args: any) => any>(func: T, wait?: number | undefined, options?: import("lodash").ThrottleSettings | undefined) => import("lodash").DebouncedFunc<T>;
    isString: (value?: any) => value is string;
    debounce: {
        <T_1 extends (...args: any) => any>(func: T_1, wait: number | undefined, options: import("lodash").DebounceSettingsLeading): import("lodash").DebouncedFuncLeading<T_1>;
        <T_2 extends (...args: any) => any>(func: T_2, wait?: number | undefined, options?: import("lodash").DebounceSettings | undefined): import("lodash").DebouncedFunc<T_2>;
    };
    pull: {
        <T_3>(array: T_3[], ...values: T_3[]): T_3[];
        <T_4>(array: import("lodash").List<T_4>, ...values: T_4[]): import("lodash").List<T_4>;
    };
    ...
    cloneDeep: <T_5>(value: T_5) => T_5;
    uniq: <T_6>(array: import("lodash").List<T_6> | null | undefined) => T_6[];
    clamp: {
    ...
    get: {
        ...
        <TObject_8 extends object, TKey1_1 extends keyof TObject_8, TKey2_1 extends keyof TObject_8[TKey1_1]>(object: TObject_8 | null | undefined, path: [TKey1_1, TKey2_1]): TObject_8[TKey1_1][TKey2_1] | undefined;
        <TObject_9 extends object, TKey1_2 extends keyof TObject_9, TKey2_2 extends keyof TObject_9[TKey1_2], TDefault_1>(object: TObject_9 | null | undefined, path: [TKey1_2, TKey2_2], defaultValue: TDefault_1): TDefault_1 | Exclude<TObject_9[TKey1_2][TKey2_2], undefined>;
        ...
        <TObject_11 extends object, TKey1_4 extends keyof TObject_11, TKey2_4 extends keyof TObject_11[TKey1_4], TKey3_1 extends keyof TObject_11[TKey1_4][TKey2_4]>(object: TObject_11 | null | undefined, path: [TKey1_4, TKey2_4, TKey3_1]): TObject_11[TKey1_4][TKey2_4][TKey3_1] | undefined;
        <TObject_12 extends object, TKey1_5 extends keyof TObject_12, TKey2_5 extends keyof TObject_12[TKey1_5], TKey3_2 extends keyof TObject_12[TKey1_5][TKey2_5], TDefault_2>(object: TObject_12 | null | undefined, path: [TKey1_5, TKey2_5, TKey3_2], defaultValue: TDefault_2): TDefault_2 | Exclude<TObject_12[TKey1_5][TKey2_5][TKey3_2], undefined>;
        ...
        <TObject_14 extends object, TKey1_7 extends keyof TObject_14, TKey2_7 extends keyof TObject_14[TKey1_7], TKey3_4 extends keyof TObject_14[TKey1_7][TKey2_7], TKey4_1 extends keyof TObject_14[TKey1_7][TKey2_7][TKey3_4]>(object: TObject_14 | null | undefined, path: [TKey1_7, TKey2_7, TKey3_4, TKey4_1]): TObject_14[TKey1_7][TKey2_7][TKey3_4][TKey4_1] | undefined;
        <TObject_15 extends object, TKey1_8 extends keyof TObject_15, TKey2_8 extends keyof TObject_15[TKey1_8], TKey3_5 extends keyof TObject_15[TKey1_8][TKey2_8], TKey4_2 extends keyof TObject_15[TKey1_8][TKey2_8][TKey3_5], TDefault_3>(object: TObject_15 | null | undefined, path: [TKey1_8, TKey2_8, TKey3_5, TKey4_2], defaultValue: TDefault_3): TDefault_3 | Exclude<TObject_15[TKey1_8][TKey2_8][TKey3_5][TKey4_2], undefined>;
        <T_7>(object: import("lodash").NumericDictionary<T_7>, path: number): T_7;
        <T_8>(object: import("lodash").NumericDictionary<T_8> | null | undefined, path: number): T_8 | undefined;
        <T_9, TDefault_4>(object: import("lodash").NumericDictionary<T_9> | null | undefined, path: number, defaultValue: TDefault_4): T_9 | TDefault_4;
        ...
        <TObject_16, TPath extends string>(data: TObject_16, path: TPath): string extends TPath ? any : import("lodash").GetFieldType<TObject_16, TPath>;
        <TObject_17, TPath_1 extends string, TDefault_6 = import("lodash").GetFieldType<TObject_17, TPath_1>>(data: TObject_17, path: TPath_1, defaultValue: TDefault_6): TDefault_6 | Exclude<import("lodash").GetFieldType<TObject_17, TPath_1>, null | undefined>;
