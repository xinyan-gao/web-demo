...
export default class TAAPass extends BaseNormalPass {
  constructor(shaderModuleService) {
    super();
    /**
     * 低差异序列
     */
    _defineProperty(this, "haltonSequence", []);
    /**
     * 当前累加任务 ID，例如用户连续拖拽时上一次累加很有可能没有结束，此时在开启新一轮累加之前需要结束掉之前未完成的
     */
    _defineProperty(this, "accumulatingId", 0);
    /**
     * 每一轮累加中的 frameID
     */
    ...
    _defineProperty(this, "sampleRenderTarget", void 0);
    _defineProperty(this, "prevRenderTarget", void 0);
    _defineProperty(this, "outputRenderTarget", void 0);
    _defineProperty(this, "copyRenderTarget", void 0);
    _defineProperty(this, "blendModel", void 0);
    _defineProperty(this, "outputModel", void 0);
    _defineProperty(this, "copyModel", void 0);
